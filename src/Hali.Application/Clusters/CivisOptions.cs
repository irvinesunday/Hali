...
public class CivisOptions
{
    ...
    public CivisCategoryOptions Transport { get; set; } = new() { BaseFloor = 2, HalfLifeHours = 8, MacfMin = 2, MacfMax = 5 };
    public CivisCategoryOptions Electricity { get; set; } = new() { BaseFloor = 2, HalfLifeHours = 12, MacfMin = 2, MacfMax = 6 };
    public CivisCategoryOptions Water { get; set; } = new() { BaseFloor = 2, HalfLifeHours = 24, MacfMin = 2, MacfMax = 7 };
    public CivisCategoryOptions Environment { get; set; } = new() { BaseFloor = 2, HalfLifeHours = 36, MacfMin = 2, MacfMax = 6 };
    public CivisCategoryOptions Safety { get; set; } = new() { BaseFloor = 2, HalfLifeHours = 18, MacfMin = 2, MacfMax = 6 };
    public CivisCategoryOptions Infrastructure { get; set; } = new() { BaseFloor = 2, HalfLifeHours = 24, MacfMin = 2, MacfMax = 6 };
    public CivisCategoryOptions Governance { get; set; } = new() { BaseFloor = 2, HalfLifeHours = 24, MacfMin = 2, MacfMax = 6 };

    public CivisCategoryOptions GetCategoryOptions(CivicCategory category) => category switch
    {
